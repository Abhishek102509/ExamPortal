...
public class StudentQueryController {
    ...
    @PutMapping("/{queryId}")
    @PreAuthorize("hasRole('TEACHER')")
    @Operation(summary = "Update a query with response (Teacher only)")
    public ResponseEntity<StudentQueryResponseDTO> updateQuery(@PathVariable Long queryId, @Valid @RequestBody StudentQueryUpdateDTO updateDTO) {
        StudentQueryResponseDTO updatedQuery = studentQueryService.updateQuery(queryId, updateDTO);
