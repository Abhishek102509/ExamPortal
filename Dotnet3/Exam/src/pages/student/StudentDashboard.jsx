                      ...
                      <Card.Body className="py-3">
                        <div className="d-flex align-items-center justify-content-between">
                          <div className="flex-grow-1">
                            ...
                            <small className="text-muted">
                              Completed on {result.submittedAt ? new Date(result.submittedAt).toLocaleDateString() : 'N/A'}
                            </small>
                          </div>
                          <div className="text-end ms-2">
                            ...
                            <small className="text-muted">
                              {result.obtainedMarks !== undefined && result.totalMarks !== undefined ? `${result.obtainedMarks}/${result.totalMarks}` : 'N/A'}
                            </small>
                          </div>
                        </div>
                      </Card.Body>
